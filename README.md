...
![VINIMAY](./public/screenshot-1.png)
![VINIMAY](./public/screenshot-2.png)
![VINIMAY](./public/screenshot-3.png)
...
| Mock Data | Local JavaScript constants in `/src/data/mockData.js` |
| Build | Vite |
...
│   │   │   ├── SidebarNav.jsx
│   │   │   ├── TopNav.jsx
│   │   │   └── BottomNav.jsx      # Mobile glassmorphic nav
│   │   └── shared/
│   │       ├── CreditRing.jsx     # Animated circular progress
│   │       ├── ProgressBar.jsx
│   │       └── TransactionRow.jsx
│   ├── pages/
│   │   ├── AuthPage.jsx           # Sign-in only
│   │   ├── DashboardPage.jsx
│   │   ├── UploadPage.jsx
│   │   ├── EstimatePage.jsx
│   │   ├── SchedulePage.jsx
...
│   │   └── ProfilePage.jsx
│   ├── data/
│   │   └── mockData.js            # All mock users, products, transactions
│   ├── context/
│   │   └── AuthContext.jsx        # Simple auth state (isLoggedIn boolean)
│   ├── hooks/
...
├── tailwind.config.js             # Fully custom token overrides
├── jsconfig.json
├── vite.config.js
└── README.md
```
...
All mock data lives in `/src/data/mockData.js` and is imported directly into pages and components. The file exports:
...
Each entry has `type` (`earned | spent | pending`), `icon`, `title`, `date`, and signed amount in VMC.
...
The complete token set is defined in `tailwind.config.js` and mirrored in `tokens.css`.
